...
2. [AWS Glue Use Cases](#gluecase)
3. [AWS Glue Architecture](#gluearchitecture)
4. [AWS Glue Terminology](#gluecomponent)

  4.1. [AWS Glue Data Catalog](#gluedatacatalog)
  4.2. [AWS Glue Crawlers and Classifiers](#gluecrawler)
