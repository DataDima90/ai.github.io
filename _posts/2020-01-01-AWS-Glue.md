...
- Is a central repository and persistent metadata store to store structural and operational metadata for all the data assets
- Provides a uniform repository where disparate systems can store and find metadata to keep track of data in data silos, and use that metadata to query and transform the data
