...
**Classifiers**
- Determines the schema of our data. AWS Glue provides classifiers for common file types, such as CSV, JSON, AVRO, XML, and others. 
- It also provides classifiers for common relational database management systems using a JDBC connection. 
- We can write our own classifier by using a grok pattern or by specifying a row tag in an XML document.
