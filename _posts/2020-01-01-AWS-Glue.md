...
1. [What is AWS Glue?](#gluedefinition)
2. [When Should We Use AWS Glue?](#gluecase)
3. [AWS Glue Architecture](#gluearchitecture)
4. [AWS Glue Terminology](#glueterminology)
