...
- [AWS Glue Best practives](#gluebestpractices)
...
<a name="gluebestpractices"></a>
# Best practices
Here are some of the best practices from the AWS glue documentation and related blog posts.
...
For more information, see the blog post [Optimize memory management](https://aws.amazon.com/de/blogs/big-data/optimize-memory-management-in-aws-glue/) in AWS Glue

## Use the appropriate type of scaling 
For more information, see the blog post [Best practices to scale Apache Spark jobs and partition data with AWS Glue](https://aws.amazon.com/de/blogs/big-data/best-practices-to-scale-apache-spark-jobs-and-partition-data-with-aws-glue/)


# Summary
**Usage patterns**
- Crawl our data and generate code to execute, including data transformation and loading
...
- Specify the number of Data Processing Units (DPUs) to allocate to our ETL job. 
...
- Statistics are about the health of our environment and are written to the Glue Data Catalog
